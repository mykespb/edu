...
sends = "Энтропия нарастала;И уехали в Казахстан;Динозавтр всё равно съел туристов;Держите зачётку;И все стали танцевать;Вот и сказочке конец;Так появилась Вселенная;С тех пор это закон;И немедленно выпил;)))" .split(";")
...
# ~ Динозавр приходит в парк юрского периода и говорит: 'Давай заведём котят!'. А тут по громкоговорителю: 'Я не доктор, я динозавр!'. Динозавтр всё равно съел туристов.

...
# ~ варианты
# ~ а) в тексте есть только указанные слова, -- здесь
# ~ б) текст произвольный, и в нём есть вкрапления этих слов. -- потом
...
ускорение касательная объём площадь гипербола парабола сечение пересечение проекция
"""

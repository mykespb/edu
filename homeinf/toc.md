...
По тексту с бортовыми номерами самолётов определить, 
какие 3 страны наиболее представлены в тексте.
...
2024-10-31 2026-03-14 2026-03-14 0.1
...
у получившегося числа берём остаток от деления на 10
(положительное число),
...
Буквы - только латинские.
Внутри комментариев тоже смотрим.
Выводим по 1 разу в алфавтином порядке.
...
считтаем с числом раз, проще.

football-2026-years.py
---------------------------

2026-06-27 2026-06-27 2.1
...
2025-11-13 2026-01-06 2.1

обход графа, бинарное дерево, обход в глубину
рекурсивное решение
...
обход графа, бинарное дерево, обход в глубину
оптимизированное короткое решение
...
Проанализировать список видов тарантулов и определить,
...
Решение:
1. по координатам находим длины сторон, как гипотенузы по теореме Пифагора,
...
2026-06-25 2026-06-26 2.1

Даны координаты нескольких (3+) точек на плоскости.
Найти треугольник с наибольшей площадью
(если несколько, то любой).

Решение:
1. по itertools.combinations перебираем все возможные треугольники
2. по координатам находим длины сторон, как гипотенузы по теореме Пифагора,
...
Регулярные выражения. Классика: эл.почта и т.п.
...
Регулярные выражения. Много функций и ситуаций.
...
2026-06-18 2026-06-18 0.1

Даны 2 (случайных) списка.
...
Телевизионные башни (телебашни) оцениваются по комплексу инженерных, архитектурных и технологических параметров.
...
Операции над бинарными деревьями: добавление,
вывод левый, правый.
...
дай список 100 самых знаменитых людей Великобритании за последние 300 лет; для каждого укажи полное имя, статус (титул, напр., барон, если есть), годы рождения и смерти, одно основное направление деятельности из списка (литература, наука, искусство, политика, бизнес, спорт, прочее), образование (школа или колледж, институт или университет - какие именно); вывод в формате list[dict] для python

uk-premier.py
---------------------------

2026-06-22 2026-06-22 1.1
...
1. List of all primes' names.
2. List of primes' colleges.
3. List of primes - recidivists.
etc
...
про школьников, которые проращивали зёрна,
но некоторые из них (из зёрен) всё-таки замёрзли.

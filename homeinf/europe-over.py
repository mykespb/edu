...
for num in range(total):
    ...
    if best_value >= rest_value:
        print(f"""
Площадь {num+1} крупнейших стран Западной Европы равна {best_value:.2f} тыс.кв.км
и превосходит площадь всех остальных стран, равную {rest_value:.2f} тыс.кв.км.
Это страны: """, end="")
        print( *(land['name'] for land in europe[:num+1]), sep=", ", end=".")
        break
...
for num in range(total):
    ...
    if best_value >= rest_value:
        print(f"""
Население {num+1} крупнейших стран Западной Европы равно {best_value:.2f} тыс.человек
...
# ~ Население 5 крупнейших стран Западной Европы равно 328100.00 тыс.человек

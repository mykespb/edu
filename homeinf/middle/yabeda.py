...
story_rus = "Анька говорит, что бяку делает Бориска и не надо так. А Бориска не делает, это Верка делает. Вовсе не Верка а Данька такую бяку делает, а Анька буку делает, вот так!"

#!/usr/bin/env python
# myke 2026-06-198 2026-06-24 1.3
# singers.py
...
print(f"""
самая длинная карьера:  {long[0]:3} лет: {long[1]}
самая короткая карьера: {short[0]:3} лет: {short[1]}
""")
...
# ~ """
# ~ ----------------------------------------------------------
# ~ 1. у кого самая длинная и самая короткая карьера?
# ~ ----------------------------------------------------------


# ~ самая длинная карьера:  75 лет: Pete Seeger
# ~ самая короткая карьера:  6 лет: Jim Morrison


# ~ ----------------------------------------------------------
# ~ 2. у кого карьера занимала наибольшую часть жизни?
# ~ ----------------------------------------------------------

# ~ {'name': 'Michael Jackson', 'birth': 1958, 'death': 2009, 'start': 1964, 'end': 2009, 'part': 0.8823529411764706}

# ~ обладатель самой длинной карьеры: Michael Jackson
# ~ родился в 1958 году,
# ~ умер в 2009 году,
# ~ начал петь в 1964 году,
# ~ закончил петь в 2009 году,
# ~ жил 51 лет,
# ~ пел 45 лет,
# ~ творческая часть жизни: 88%.
